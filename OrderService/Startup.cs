...
namespace OrderService
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("docs", new Info { Title = "re:Invent WIN401 Orders API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            app.UseSwagger(x => x.RouteTemplate = "api/orders/{documentName}/swagger.json");
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/api/orders/docs/swagger.json", "re:Invent WIN401 Orders API");
